...
const TeamHero = () => {
  ...
  const teamMembers = [
    { name: "Leadership", description: "Visionaries shaping our future" },
    { name: "Engineering", description: "Builders of tomorrow's solutions" },
    { name: "Design", description: "Creating experiences that matter" },
    { name: "Marketing", description: "Sharing our story with the world" },
    { name: "Support", description: "Always there when you need us" }
  ]
          ...
          <div className="text-center lg:text-left">
            ...
            >
              <h1 ref={titleRef} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white px-2 py-1 sm:px-4">
                Our <span ref={highlightRef} className="text-red-600">Team</span>
              </h1>
            </div>
