...
export default function Module() {
  ...
  const isSearchInView = useInView(searchRef, { triggerOnce: true, threshold: 0.8 });
  ...
  return (
    ...
    >
      <div
        className="relative w-full lg:w-1/2 border border-red-500 rounded-full cursor-text"
      ...
      >
        <input
          ...
          className="w-full min-h-12 pl-12 pr-20 text-white bg-black border border-red-500 rounded-full placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500"
        />
